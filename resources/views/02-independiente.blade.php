...
<html lang="es">
    <head>
        ...
        <link href="{{ asset('css/02-independiente/styles.css') }}" rel="stylesheet" />
        <link href="{{ asset('css/02-independiente/negocios-overrides.css') }}" rel="stylesheet" />
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <h4><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger text-white" href="#">{{ $negocio->profesion }}</a></h4>
                    ...
                    @for ($n = 1; $n <= 6; $n++)
                        ...
                        @if ($img)
                            <div class="col-md-6 col-lg-4 mb-5">
                                <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal{{ $n }}">
        ...
        <footer id="redes" class="footer text-center">
            <div class="container">
                <div class="row">
                    ...
                    <!-- Footer Social Icons-->
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-0 mb-lg-0">
                        <h4 class="text-uppercase mb-4">Mis Redes</h4>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 offset-md-0 col-lg-4 offset-lg-4 mb-5 mb-lg-0">
        ...
        <!-- Portfolio Modals-->
        @for ($n = 1; $n <= 6; $n++)
            @php $imgModal = $propiedades->imagenUrl("body_tarjeta_img_{$n}"); @endphp
            @if ($imgModal)
                <div class="portfolio-modal modal fade" id="portfolioModal{{ $n }}" tabindex="-1" role="dialog" aria-labelledby="portfolioModal{{ $n }}Label" aria-hidden="true">
