...
var skel = function () {
    ...
    var t = {
        ...
        initMethods: function () {
            document.addEventListener ? ! function (e, n) {
            ...
            }), t.indexOf = Array.prototype.indexOf ? function (t, e) {
                return t.indexOf(e)
            } : function (t, e) {
            ...
            }, t.iterate = Object.keys ? function (t, e) {
                if (!t) return [];
            ...
            }, t.matchesMedia = window.matchMedia ? function (t) {
                return "" == t ? !0 : window.matchMedia(t).matches
            } : window.styleMedia || window.media ? function (t) {
                if ("" == t) return !0;
                ...
                var e, n, i, a, r = {
                    ...
                    o = !1;
                n = t.split(/\s+and\s+/);
                for (a in n) e = n[a], "(" == e.charAt(0) && (e = e.substring(1, e.length - 1), i = e.split(/:\s+/), 2 == i.length && (r[i[0].replace(/^\s+|\s+$/g, "")] = parseInt(i[1]), o = !0));
                if (!o) return !1;
